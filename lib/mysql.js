...
let insertRequest = function(value) {
    let _condition = `SELECT * FROM friends WHERE uid1 = ? AND uid2 = ?;`
...
let insertFriend = function(value) {
    let _sql = `INSERT INTO friends SET uid1 = ?, uid2 = ?;
                INSERT INTO friends SET uid2 = ?, uid1 = ?;`
    return query(_sql, value)
}

let verifyRequest = function(id) {
